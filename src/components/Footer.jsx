...
function Footer() {
  return (
    <div className=" bg-gray-200 mt-20 w-100% py-5">
      <h4 className="items-center gap-3 flex justify-center text-4xl mt-10 mb-4">
      ...
      <div className="gap-4 flex justify-center items-center">
        ...
        <div>
          <button className="py-4 px-10 rounded-full  text-white bg-[#45C9A1]  font-bold">
            {" "}
            Subscribe
          </button>
        </div>
      ...
      <div className="container mx-auto">
        <div className="flex justify-between gap-10 mt-10 ">
          <div className="">
            ...
            <p className="w-60 text-1xl">
              Offering a unique andstylish perspective onfashion is our
              numberone priority. Confuseyour mirror by ourtrendy outfits.
            </p>
          </div>
